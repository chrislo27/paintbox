...
data class Insets(val top: Float, val bottom: Float, val left: Float, val right: Float) {
    ...
    operator fun plus(other: Insets): Insets =
        Insets(this.top + other.top, this.bottom + other.bottom, this.left + other.left, this.right + other.right)

    operator fun minus(other: Insets): Insets =
        Insets(this.top - other.top, this.bottom - other.bottom, this.left - other.left, this.right - other.right)

    operator fun times(other: Insets): Insets =
        Insets(this.top * other.top, this.bottom * other.bottom, this.left * other.left, this.right * other.right)

    operator fun times(multiplier: Float): Insets =
        Insets(this.top * multiplier, this.bottom * multiplier, this.left * multiplier, this.right * multiplier)

...
class CascadingRegionMap(val suppliers: List<TextureRegionMap>) : TextureRegionMap {
    ...
    override fun getIndexedRegions(id: String): Map<Int, TextureRegion> {
        return getIndexedRegionsOrNull(id)
            ?: error("No indexed map of regions found with ID $id in any of the suppliers")
    }

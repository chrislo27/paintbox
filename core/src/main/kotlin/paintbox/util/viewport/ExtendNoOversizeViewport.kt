 ...
 */
class ExtendNoOversizeViewport(
    val originalWorldWidth: Float,
    val originalWorldHeight: Float,
    camera: OrthographicCamera,
) : ScalingViewport(Scaling.fit, originalWorldWidth, originalWorldHeight, camera) {

    override fun update(screenWidth: Int, screenHeight: Int, centerCamera: Boolean) {
        val scaled =
            scaling.apply(originalWorldWidth, originalWorldHeight, screenWidth.toFloat(), screenHeight.toFloat())
